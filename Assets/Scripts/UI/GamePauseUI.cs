...
public class GamePauseUI : MonoBehaviour
{
    ...
    private void Start()
    {
        GameManager.Instance.OnLocalGamePaused += KitchenGameManager_OnLocalGamePaused;
        GameManager.Instance.OnLocalGameUnpaused += KitchenGameManager_OnLocalGameUnpaused;
